...
//促销
    ...
    public Book(Integer bookId, Integer categoryId, String name, String cover, BigDecimal price, String intro, String auther, String press, Date pubdate, Integer stock, Integer status, Integer special, Integer news, Integer sale) {
        this.bookId = bookId;
        this.categoryId = categoryId;
        this.name = name;
        this.cover = cover;
